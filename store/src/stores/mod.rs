...
//! This module defines the traits for a key-value store used for event sourcing and state 
//! snapshots in actors. 
//! The `DbManager` trait provides a factory for creating stores, while the `Store` trait defines
